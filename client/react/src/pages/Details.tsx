  ...
  return (
    <section className="bg-black text-white py-10">
        ...
        <div className="md:w-2/5 m-4 md:m-0">
          ...
          <p className="mb-8">
            ...
            <span className="text-slate-300">
              {dataObj?.rating ? Number(dataObj?.rating).toFixed(2) : 0}
            </span>
          </p>
          ...
          <p className="text-lg mb-6">
            <span className="font-bold me-1">Added By</span>
            ...
            {x.user_id == context?.user?.user_id && (
              <div className="flex justify-end">
                <button
                  ...
                  type="button"
                  className="btn bg-transparent btn-nav-l text-white min-h-0 h-auto p-1 px-2 me-2"
                >
                  <i className="fa-regular fa-pen-to-square"></i>
                </button>
                <button
                  type="button"
                  className="btn bg-transparent btn-nav-l text-white min-h-0 h-auto p-1 px-2"
                  onClick={() => {
                    setRr_id(x.rr_id);
                    setShowModal(true);
                  }}
      ...
      <DetailsModals
        ...
        showUFC={showUFC}
        showModal_1={showModal_1}
        showModal_4={showModal_4}
        setShowModal_4={setShowModal_4}
        showModal_5={showModal_5}
        setShowModal_5={setShowModal_5}
        showModal_2={showModal_2}
        setShowModal_2={setShowModal_2}
        showModal_4A1={showModal_4A1}
        showModal_4A2={showModal_4A2}
        setShowModal_4A1={setShowModal_4A1}
        setShowModal_4A2={setShowModal_4A2}
      />
    </section>
  );
...
//           </svg>
//           <span className='text-slate-300'> {dataObj?.rating ? Number(dataObj?.rating).toFixed(2) : 0}</span>
//         </p>
